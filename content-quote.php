...
?>
	...
	<div class="below-title-meta">
		<div class="adt">
		 ...
		 <a class="link-comments" href="<?php  comments_link(); ?>"><?php comments_number(__('Keine Kommentare','themonic'),__('1 Kommentar'),__('% Kommentare')); ?></a></span> 
         </div>       
      ...
      <p class="quote-credit"><?php echo get_post_meta(get_the_ID(), 'quote-credit', true); ?></p>
		</div><!-- .entry-summary -->
		<?php else : ?>
